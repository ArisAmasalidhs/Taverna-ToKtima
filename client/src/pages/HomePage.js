    ...
    <div className="homepage">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <button onClick={() => navigate('/menu')} className="btn-primary">View Menu</button>
        </div>
      </section>
      ...
      <section className="featured-menu-section">
        ...
        <div className="menu-cards">
          ...
          <div className="menu-card">
            <img src="https://www.mygreekdish.com/wp-content/uploads/2013/05/Moussaka-recipe-Traditional-Greek-Moussaka-with-Eggplants.jpg" alt="Moussaka" />
            <h3>Moussaka</h3>
            <p>A baked dish with eggplant, potatoes, and creamy béchamel sauce.</p>
          </div>
          <div className="menu-card">
            <img src="https://upload.wikimedia.org/wikipedia/commons/c/c7/Baklava%281%29.png" alt="Baklava" />
            <h3>Baklava</h3>
